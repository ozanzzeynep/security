...
@Configuration
@EnableWebSecurity //Security filter chain i uygulayamayız bunu yazmazsak.
@EnableMethodSecurity //Path değil direk olarak controller sınıfını verirsek onların security saplıyor.
